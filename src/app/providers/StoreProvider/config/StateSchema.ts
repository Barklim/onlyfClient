...
import { AccountsPageSchema } from '@/pages/AccountsPage';
...
import { SettingsSchema } from '@/features/SettingsSections/model/types/settingsSchema';
...
export interface StateSchema {
    ...
    activeDialogs?: ActiveDialogsSchema;
