...
import { getAgencyIsLoading, getSettingsAgencyNameForm } from '@/features/SettingsSections/model/selectors/getSettingsForm/getSettingsForm';
...
export const SettingsAgencyName = memo(() => {
    ...
    const { agencyNameRef } = useToolbarRefs();
    const ref = useRef<HTMLDivElement | null>(null);

    useEffect(() => {
        agencyNameRef.current = ref.current;
    }, [agencyNameRef]);
